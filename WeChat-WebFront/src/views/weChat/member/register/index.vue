...
<template>
  <div class="register">
    <header>
      <div>购买成功，恭喜您成为小宝图书馆的会员！</div>
      <div>请<b style="color:red;">务必</b>完善以下信息，帮助我们更好的为您提供服务</div>
    </header>
    ...
    <x-button class="btns"
      ...
      @click.native="submitMembershipCard">确认提交</x-button>
    <div class="describe">请放心，我们会妥善保管您的个人信息。手机号码作为您到店入场时快速查询会员信息的依据。填写宝宝信息，我们将在宝宝生日时送上一份惊喜。</div>
  </div>
</template>

<script>
import Agreement from '../registerAred/agreement'
import {
  XInput,
  Group,
  XButton,
